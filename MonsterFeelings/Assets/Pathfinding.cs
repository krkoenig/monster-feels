...
public class Pathfinding : MonoBehaviour
{
	...
	public LinkedList<Tile> close_search (Tile origin, int MP)
	{
		...
		up = new Tile(tiley.getTile(xcoord, ycoord + 1).getPosition(), tiley.getTile(xcoord, ycoord + 1).getTerrain());
		right = new Tile (tiley.getTile (xcoord + 1, ycoord).getPosition (), tiley.getTile (xcoord + 1, ycoord).getTerrain ());
		bot = new Tile (tiley.getTile (xcoord, ycoord - 1).getPosition (), tiley.getTile (xcoord, ycoord - 1).getTerrain ()); 
		left = new Tile (tiley.getTile (xcoord - 1, ycoord).getPosition (), tiley.getTile (xcoord - 1, ycoord).getTerrain ());
